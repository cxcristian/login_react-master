...
// utilizamos la funcion props , el cual me trae la propiedad del componente padre , que es registrar , y pone en menu principal el nombre del usuario que entro
...
// Tenemos una funcion llamada cerrar sesion , la cual me permite mediante getElementByID con simple logica , sin estar conectado a la bd , simplemten bloquea el diplay y queda en login
...
{/* Estamos renderisando las otras paginas para poder que se muestren en el archivo menu */}
    { reg === "1" && <Registrar/> }
    { lis === "1" && <Listar/> }
    { est === "1" && <Estadistica/>}
